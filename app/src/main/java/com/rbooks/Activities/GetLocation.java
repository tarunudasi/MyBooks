                        ...
                        placeResult.setResultCallback(new ResultCallback<PlaceBuffer>() {
                            ...
                            public void onResult(PlaceBuffer places) {
                                if(places.getCount()==1){
                                    ...
                                    try {
                                        LocationPrefs.getInstance(GetLocation.this).clearLocation();
                                        LocationPrefs.getInstance(GetLocation.this).setLocation(new LocationModel(places.get(0).getLatLng().latitude, places.get(0).getLatLng().longitude));
                        ...
                        case LocationSettingsStatusCodes.SUCCESS:
                            ...
                            if( mLocation == null ){
                                LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, locationRequest, new LocationListener() {
                                    ...
                                    public void onLocationChanged(Location location) {
                                        try {
                                            ...
                                            LocationPrefs.getInstance(GetLocation.this).setLocation(new LocationModel(location.getLatitude(), location.getLongitude()));
                                            startActivity(new Intent(GetLocation.this, MainActivity.class));
                                            overridePendingTransition(R.anim.right_enter, R.anim.slide_out);
                                            GetLocation.this.finish();
                                        } catch (IOException e) {
                                ...
                                try {
                                    LocationPrefs.getInstance(GetLocation.this).clearLocation();
                                    getCity(mLocation.getLatitude(), mLocation.getLongitude());
                                    LocationPrefs.getInstance(GetLocation.this).setLocation(new LocationModel(mLocation.getLatitude(), mLocation.getLongitude()));
                                    startActivity(new Intent(GetLocation.this, MainActivity.class));
                                    overridePendingTransition(R.anim.right_enter, R.anim.slide_out);
                                    GetLocation.this.finish();
                                } catch (IOException e) {
...
//        LocationModel.distanceBetween(latitude, longitude, 22.7441, 77.7370, results);
