...
public class ChangeMobile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        LinearLayout change_number_layout = (LinearLayout) view.findViewById(R.id.change_number_layout);
        ViewGroup.LayoutParams params = change_number_layout.getLayoutParams();
// Changes the height and width to the specified *pixels*
        params.height = 0;
        params.width = (int)((float)displayMetrics.widthPixels * 0.75);
        change_number_layout.setLayoutParams(params);
        ...
        change_number_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (change_number.getText().length() < 3){
