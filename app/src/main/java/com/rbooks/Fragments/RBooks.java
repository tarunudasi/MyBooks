...
import com.rbooks.Activities.SearchableActivity;
import com.rbooks.Adapter.CategoryRecyclerAdapter;
...
public class RBooks extends Fragment {
    ...
    private void initialize(View view){
        ...
        categoryRecyclerAdapter = new CategoryRecyclerAdapter(list, getContext(), getActivity());
