...
public class AuthorTab extends Fragment {

    private RecyclerView recyclerView;
    private SearchAdapterTitle adapter;
    private List<Search> list;
    private static final String VOLLEY_TAG = "AUTHOR_VT";

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.author_tab,container,false);

        list = new ArrayList<>();
        recyclerView = (RecyclerView) view.findViewById(R.id.search_list_view_author);
    ...
    private void getData(final String data){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UrlConstant.SEARCH_BY_AUTHOR,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0 ; i < jsonArray.length() ; i++){
                                ...
                                list.add(new Search(object.getString("author")));
