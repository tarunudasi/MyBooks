...
public class NewOtpVerify extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        LinearLayout new_otp_verify_layout = (LinearLayout) view.findViewById(R.id.new_otp_verify_layout);
        ViewGroup.LayoutParams params = new_otp_verify_layout.getLayoutParams();
// Changes the height and width to the specified *pixels*
        params.height = 0;
        params.width = (int)((float)displayMetrics.widthPixels * 0.75);
        new_otp_verify_layout.setLayoutParams(params);
