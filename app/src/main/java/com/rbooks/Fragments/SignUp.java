...
public class SignUp extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        LinearLayout sign_up_layout = (LinearLayout) view.findViewById(R.id.sign_up_layout);
        ViewGroup.LayoutParams params = sign_up_layout.getLayoutParams();
// Changes the height and width to the specified *pixels*
        params.height = 0;
        params.width = (int)((float)displayMetrics.widthPixels * 0.75);
        sign_up_layout.setLayoutParams(params);
